...
def rotary_attn_pytorch_func(
    *,
    ...
    query = RotaryEmbedding.apply_rotary_emb(q_pos_emb, query, head_dim=1)
    key = RotaryEmbedding.apply_rotary_emb(kv_pos_emb, key, head_dim=1)
    if rotate_value:
        value = RotaryEmbedding.apply_rotary_emb(kv_pos_emb, value, head_dim=1)
...
def rotary_attn_xformers_func(
    *,
    ...
    query = RotaryEmbedding.apply_rotary_emb(q_pos_emb, query, head_dim=2)
    key = RotaryEmbedding.apply_rotary_emb(kv_pos_emb, key, head_dim=2)

    if rotate_value:
        value = RotaryEmbedding.apply_rotary_emb(kv_pos_emb, value, head_dim=2)
...
def rotary_attn_xformers_varlen_func(
    *,
    ...
    query = RotaryEmbedding.apply_rotary_emb(q_pos_emb.unsqueeze(0), query)
    key = RotaryEmbedding.apply_rotary_emb(kv_pos_emb.unsqueeze(0), key)

    if rotate_value:
        value = RotaryEmbedding.apply_rotary_emb(kv_pos_emb.unsqueeze(0), value)
