    ...
    objects={
        ...
        "units": TemporalObjectSpec(
            ...
            attributes={
                ...
                "average_waveform": ArraySpec(
                    dtype="float32",
                    shape=["n_units", "waveform_samples"],
                    distribution="normal",
                    params={"mean": 1.0, "std": 100.0},
                ),
                "channel_name": ArraySpec(
                    dtype="str",
                    shape=["n_units"],
                    distribution="sequential_str",
                    params={"prefix": "elec_"},
                ),
                "channel_number": ArraySpec(
                    dtype="int64",
                    shape=["n_units"],
                    distribution="sequential_int",
                ),
                "count": ArraySpec(
                    dtype="int64",
                    shape=["n_units"],
                    distribution="randint",
                    params={"low": 1, "high": 50000},
                ),
        ...
        "cursor": TemporalObjectSpec(
            ...
            attributes={
                ...
                "vel": ArraySpec(
                    ...
                    shape=["n_behavior_samples", 2],
                    distribution="normal",
                    params={"mean": 0.0, "std": 400.0},
                ),
                "acc": ArraySpec(
                    dtype="float64",
                    shape=["n_behavior_samples", 2],
                    distribution="normal",
                    params={"mean": 0.0, "std": 8000.0},
                ),
            },
        ),
        "finger": TemporalObjectSpec(
            ...
            attributes={
                ...
                "vel_3d": ArraySpec(
                    ...
                    shape=["n_behavior_samples", 3],
                    distribution="normal",
                    params={"mean": 0.0, "std": 25.0},
                ),
                "angular_vel": ArraySpec(
                    dtype="float64",
                    shape=["n_behavior_samples", 3],
                    distribution="normal",
                    params={"mean": 0.0, "std": 2500.0},
                ),
                "orientation": ArraySpec(
                    dtype="float64",
                    shape=["n_behavior_samples", 3],
                    distribution="normal",
                    params={"mean": 0.0, "std": 60.0},
                ),
            },
        ),
    },
        ...
        "trials": TemporalObjectSpec(
            ...
            attributes={
                ...
                "delay": ArraySpec(
                    ...
                    shape=["n_trials"],
                    distribution="randint",
                    params={"low": 14, "high": 1000},
                ),
                "maze_id": ArraySpec(
                    dtype="int64",
                    shape=["n_trials"],
                    distribution="randint",
                    params={"low": 2, "high": 78},
                ),
                "num_barriers": ArraySpec(
                    dtype="int64",
                    shape=["n_trials"],
                    distribution="randint",
                    params={"low": 0, "high": 10},
                ),
                "num_targets": ArraySpec(
                    dtype="int64",
                    shape=["n_trials"],
                    distribution="choice",
                    params={"values": [1, 2, 3]},
                ...
                "rt": ArraySpec(
                    ...
                    shape=["n_trials"],
                    distribution="randint",
                    params={"low": 240, "high": 760},
                ),
                "split_indicator": ArraySpec(
                    dtype="str",
                    shape=["n_trials"],
                    distribution="choice",
                    params={"values": ["train", "val"]},
                ),
                "success": ArraySpec(
                    dtype="bool",
                    shape=["n_trials"],
                ...
                "trial_type": ArraySpec(
                    dtype="int64",
                    shape=["n_trials"],
                    distribution="randint",
                    params={"low": 2, "high": 13},
                ),
                "trial_version": ArraySpec(
                    dtype="int64",
                    shape=["n_trials"],
                    distribution="choice",
                    params={"values": [0, 1, 2]},
