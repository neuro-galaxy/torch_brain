...
.. tip::
   ...
   You can skip installing ``torch`` if you only wish to work with
   :obj:`torch_brain.data` and :obj:`torch_brain.pipeline` related modules,
   e.g. when focusing on pre-processing datasets.
