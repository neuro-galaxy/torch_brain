...
def test_downsampling_centered_regular(
    ...
    # Test on a centered window for resampling regular data
    ...
    resampled_values = transformed_data.regular_att.values
    ...
    assert np.array_equal(resampled_values, expected_resampled_values)
